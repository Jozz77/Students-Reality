      ...
      <main className="overflow-x-auto bg-NormalWhite  rounded-l-[40px] h-[100vh] pt-6 xxl:pt-8 px-[3%] ">
        ...
        <section className=" flex justify-between items-center">
          <div>
            ...
            <p className=" text-Gray600 text-[0.75rem] md:text-[0.8rem] lg:text-[0.9rem]  xxl:text-base">
        ...
        <section className=" flex justify-between mt-6 xxl:mt-8 font-medium text-[0.95rem] xxl:text-base">
          <div className=" w-[49%] border-Gray200 border-[1px] text-[0.85rem] border-solid rounded-[12px] py-3 md:py-4 px-[2%] ">
            <small>Total Students</small>
            <h3 className=" mt-1 xxl:mt-4 font-semibold text-[1.4rem] md:text-[1.6rem] lg:text-[1.8rem] xl:text-[2rem] xxl:text-[2.2rem] ">
              2,420
            </h3>
          </div>
        ...
        <section className="mt-6 xxl:mt-8 border-Gray200 shadow-sm border-[1px] border-solid  rounded-[8px] ">
          <div className=" flex justify-between py-2 xxl:py-3 px-[2%] ">
            <section className=" flex justify-between  lg:w-[35%] w-[45%] md:w-[40%] xl:w-[30%] text-Gray700 text-[0.7rem] md:text-[0.75rem] lg:text-[0.8rem] xxl:text-[0.9rem] font-medium  rounded-[8px] border-Gray200 border-[1px] border-solid">
            ...
            <section className=" flex items-center justify-between w-[46%] ">
              <div className=" relative w-[78%] text-[0.65rem] md:text-[0.7rem] lg:text-[0.8rem] xxl:text-[0.9rem] xxl:text-base ">
                <input
                  type="text"
                  className=" rounded-[6px] w-full outline-none py-2 pl-[13%] md:pl-[10%] border-Gray200 border-[1px] border-solid  "
                  name=""
                  id=""
              ...
              <div className="border-Gray200 w-[20%] border-[1px] text-Gray700 text-[0.7rem] md:text-[0.75rem] lg:text-[0.8rem] xxl:text-[0.9rem] rounded-[6px] border-solid  items-center justify-center flex gap-2">
        ...
        <section className="mt-8 xxl:mt-10 relative mb-16 ">
          <div className="flex absolute translate-x-[-50%] text-Gray700 font-semibold text-[0.7rem] md:text-[0.8rem] xxl:text-[0.9rem] left-[50%] top-[50%] translate-y-[-50%] justify-center items-center border-Gray200 border-[1px] border-solid  rounded-[8px]">
