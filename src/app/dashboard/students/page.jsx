    ...
    <DashboardLayout>
      <main className="overflow-x-auto bg-NormalWhite  rounded-l-[0px] sm:rounded-l-[40px] h-[100vh] pt-6 xxl:pt-8 px-[5%] sm:px-[3%] ">
        <section className="flex justify-between items-center sm:hidden">
          ...
          {/* mobile nav starts */}
        {isOpen && (
          <div className=" block sm:hidden absolute z-10 left-0 bottom-0 px-[2%] w-[50%] bg-ButtonColor h-[100vh] ">
            <div onClick={toggleMenu} className=" text-NormalWhite mt-2 text-[2rem] ">
                <MdOutlineClose />
              </div>
          <section className=" relative text-[0.7rem] md:text-[0.8rem] lg:text-[0.9rem] xxl:text-base text-NormalWhite mt-8 xxl:mt-16 ">
            <input
              type="text"
        ...
        <section className=" border-Gray200 border-t-[1px] sm:border-none pt-2 sm:pt-0 mt-3 sm:mt-0 flex flex-col sm:flex-row justify-between items-start sm:items-center">
          ...
          <div className=" text-[0.65rem] sm:text-[0.7rem] md:text-[0.75rem] xl:text-[0.8rem] xxl:text-[0.9rem] items-center font-medium cursor-pointer flex gap-2 rounded-[6px] bg-ButtonColor text-NormalWhite py-2 px-2 sm:px-2 md:px-3 xl:px-4 ">
            <div className=" mt-3 sm:mt-0 text-[0.9rem] md:text-[1rem] xl:text-[1.1rem]">
              <FiPlus />
            </div>
            <p>Add Students</p>
          </div>
